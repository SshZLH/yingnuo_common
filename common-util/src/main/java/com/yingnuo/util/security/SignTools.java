package com.yingnuo.util.security;
...
//        System.out.println(SignTools.md5("wanhuchina-thirdLock"));
//        System.out.println(SignTools.md5("wanhuchina-xiecheng"));
//        System.out.println(SignTools.md5("wanhuchinaSendService2018-05-07"));
        System.out.println(SignTools.md5("wanhuchinaSendService2018-05-07"));
        System.out.println(SignTools.md5("wanhuchina泊文科技2018-05-07"));
        String uuid = CommonUtil.getUUID().replace("-", "");
